#include "T05_ParallaxMap_01_Base.h"
#include "GLFW/glfw3.h"

namespace test {

	T05_ParallaxMap_01_Base::T05_ParallaxMap_01_Base()
		: m_f_fov(45.0f),
		...
		m_b_mesh_Wood(false), m_b_discardFragment_outside(true), m_b_OffsetLimit(false)
	{
		...
		*/
		...
		m_ShaderMesh = std::make_shared<Shader>("src/tests/05_Advanced_Lighting/05_Parallax_Mapping/S05_ParallaxMap_01_Base.Shader");
	...
	void T05_ParallaxMap_01_Base::OnUpdate(float deltaTime)
	{
	}

	void T05_ParallaxMap_01_Base::OnRender(GLFWwindow* window)
	{
	...
	void T05_ParallaxMap_01_Base::OnImGuiRender()
	{
		ImGui::Text("Parallax Mapping 01 - Base");
		//IMGUI_FPS;
		...
		ImGui::SliderFloat("Height:", &m_f_heightScale, 0.0f, .3f);
	...
	void T05_ParallaxMap_01_Base::OnProcessInput(GLFWwindow * window, float deltaTime)
	{
	...
	void T05_ParallaxMap_01_Base::framebuffer_size_callback(GLFWwindow * window, int width, int height)
	{
		if (!window)
		{
			// 
	...
	void T05_ParallaxMap_01_Base::mouse_callback(GLFWwindow * window, double xpos, double ypos)
	{
	...
	void T05_ParallaxMap_01_Base::ManualCalculationTangentAndBitanget(float * ptr_quad)
	{
		// positions 
