#include "T09_GeometryShader_04_Exploding.h"
#include "GLFW/glfw3.h"

namespace test {

	T09_GeometryShader_04_Exploding::T09_GeometryShader_04_Exploding()
		: m_f_fov(45.0f),
		m_b_firstMouse(true),
		m_mouse_lock(false),
	...
	void T09_GeometryShader_04_Exploding::OnUpdate(float deltaTime)
	{
	}

	void T09_GeometryShader_04_Exploding::OnRender(GLFWwindow* window)
	{
	...
	void T09_GeometryShader_04_Exploding::OnImGuiRender()
	{
	...
	void T09_GeometryShader_04_Exploding::OnProcessInput(GLFWwindow * window, float deltaTime)
	{
	...
	void T09_GeometryShader_04_Exploding::framebuffer_size_callback(GLFWwindow * window, int width, int height)
	{
		if (!window)
		{
			// 
	...
	void T09_GeometryShader_04_Exploding::mouse_callback(GLFWwindow * window, double xpos, double ypos)
	{
