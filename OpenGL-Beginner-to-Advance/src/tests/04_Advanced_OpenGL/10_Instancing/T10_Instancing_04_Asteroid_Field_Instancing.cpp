#include "T10_Instancing_04_Asteroid_Field_Instancing.h"
...
namespace test {
	...
	T10_Instancing_04_Asteroid_Field_Instancing::T10_Instancing_04_Asteroid_Field_Instancing()
		: m_f_fov(45.0f),
		m_b_firstMouse(true),
		m_mouse_lock(false),
		...
		m_framebufferWidth(WINDOW_WIDTH), m_framebufferHeight(WINDOW_HEIGHT)
	{
		...
		m_ShaderInstance = std::make_unique<Shader>("src/tests/04_Advanced_OpenGL/10_Instancing/S10_Instancing_04_Asteroid_Field_Instancing.Shader");
	...
	void T10_Instancing_04_Asteroid_Field_Instancing::OnUpdate(float deltaTime)
	{
	}

	void T10_Instancing_04_Asteroid_Field_Instancing::OnRender(GLFWwindow* window)
	{
	...
	void T10_Instancing_04_Asteroid_Field_Instancing::OnImGuiRender()
	{
	...
	void T10_Instancing_04_Asteroid_Field_Instancing::OnProcessInput(GLFWwindow * window, float deltaTime)
	{
	...
	void T10_Instancing_04_Asteroid_Field_Instancing::framebuffer_size_callback(GLFWwindow * window, int width, int height)
	{
		if (!window)
		{
			// 
	...
	void T10_Instancing_04_Asteroid_Field_Instancing::mouse_callback(GLFWwindow * window, double xpos, double ypos)
	{
