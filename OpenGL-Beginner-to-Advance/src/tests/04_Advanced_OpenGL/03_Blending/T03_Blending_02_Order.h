...
namespace test {
	...
	class T03_Blending_02_Order : public Test
	{
	public:
		T03_Blending_02_Order();
		~T03_Blending_02_Order();
	...
	private:
		...
		// Grass
		std::shared_ptr<Texture> msp_mTextureWindow;
		std::vector<std::shared_ptr<Texture>> msp_mTextures3;

		// MODEL
		std::unique_ptr<Model> m_model;

		// Blending
		bool m_i_sorted_windows;
	};
