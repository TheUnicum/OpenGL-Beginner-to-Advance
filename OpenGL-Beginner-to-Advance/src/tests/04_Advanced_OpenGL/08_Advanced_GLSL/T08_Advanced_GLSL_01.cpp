#include "T08_Advanced_GLSL_01.h"
#include "GLFW/glfw3.h"

namespace test {

	T08_Advanced_GLSL_01::T08_Advanced_GLSL_01()
		: m_f_fov(45.0f),
		m_b_firstMouse(true),
		m_mouse_lock(false),
		m_b_VSync_disabled(false), m_b_VSync_disabled_i_1(false)
	{
		...
		m_ShaderMesh = std::make_unique<Shader>("src/tests/04_Advanced_OpenGL/08_Advanced_GLSL/S08_Advanced_GLSL_01.Shader");
	...
	void T08_Advanced_GLSL_01::OnUpdate(float deltaTime)
	{
	}

	void T08_Advanced_GLSL_01::OnRender(GLFWwindow* window)
	{
	...
	void T08_Advanced_GLSL_01::OnImGuiRender()
	{
	...
	void T08_Advanced_GLSL_01::OnProcessInput(GLFWwindow * window, float deltaTime)
	{
	...
	void T08_Advanced_GLSL_01::framebuffer_size_callback(GLFWwindow * window, int width, int height)
	{
	}

	void T08_Advanced_GLSL_01::mouse_callback(GLFWwindow * window, double xpos, double ypos)
	{
	...
	void T08_Advanced_GLSL_01::DrawCube(glm::vec3 position, glm::mat4 proj, glm::mat4 view)
	{
		m_ShaderMesh->Bind();
		...
		m_mesh->vaBind();
		GLCall(glDrawArrays(GL_POINTS, 0, m_mesh->GetVertexCount()));// m_v_count
	}
}
