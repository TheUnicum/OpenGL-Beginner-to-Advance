#include "T02_SpecIBL_01.h"
#include "GLFW/glfw3.h"

namespace test {

	T02_SpecIBL_01::T02_SpecIBL_01()
		: m_f_fov(45.0f),
		m_b_firstMouse(true),
		m_mouse_lock(false),
		...
		m_i_sel_irradianceLighting(0)
	{
		...
		m_Shader = std::make_unique<Shader>(
			"src/tests/06_PBR/03_IBL/02_Specular_IBL/S02_SpecIBL_01.Shader");
		m_ShaderEquirectangularToCubemap = std::make_unique<Shader>(
			"src/tests/06_PBR/03_IBL/02_Specular_IBL/S02_SpecIBL_01_EquirectangularToCubemap.Shader");
	...
	void T02_SpecIBL_01::OnUpdate(float deltaTime)
	{
	}

	void T02_SpecIBL_01::OnRender(GLFWwindow* window)
	{
	...
	void T02_SpecIBL_01::OnImGuiRender()
	{
	...
	void T02_SpecIBL_01::OnProcessInput(GLFWwindow * window, float deltaTime)
	{
	...
	void T02_SpecIBL_01::framebuffer_size_callback(GLFWwindow * window, int width, int height)
	{
		if (!window)
		{
			// 
	...
	void T02_SpecIBL_01::mouse_callback(GLFWwindow * window, double xpos, double ypos)
	{
	...
	void T02_SpecIBL_01::fill_sphere_mesh_vertices()
	{
	...
	void T02_SpecIBL_01::FramebufferSetup(int width, int height)
	{
