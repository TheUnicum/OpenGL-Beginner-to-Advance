...
namespace test {
	...
	class T01_Diffuse_irradiance_02 : public Test
	{
	public:
		T01_Diffuse_irradiance_02();
		~T01_Diffuse_irradiance_02();
	...
	private:
		...
		std::shared_ptr<Texture> m_hdrTexture, m_envCubeMap, m_irradianceCubeMap;
		...
		bool m_b_irradianceCubeMap, m_b_irradianceLighting, m_b_show_hdrEnvMapCube;
	};
