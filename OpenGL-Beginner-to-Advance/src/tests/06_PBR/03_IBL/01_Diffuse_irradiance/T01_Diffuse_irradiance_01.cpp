#include "T01_Diffuse_irradiance_01.h"
#include "GLFW/glfw3.h"

namespace test {

	T01_Diffuse_irradiance_01::T01_Diffuse_irradiance_01()
		: m_f_fov(45.0f),
		m_b_firstMouse(true),
		m_mouse_lock(false),
		...
		m_hdrEnvMapCubeWidth(512), m_hdrEnvMapCubeHeight(512)
	{
		...
		m_Shader = std::make_unique<Shader>("src/tests/06_PBR/03_IBL/01_Diffuse_irradiance/S01_Diffuse_irradiance_01.Shader");
		m_ShaderEquirectangularToCubemap = std::make_unique<Shader>("src/tests/06_PBR/03_IBL/01_Diffuse_irradiance/S01_Diffuse_irradiance_01_EquirectangularToCubemap.Shader");
		m_ShaderBackground = std::make_unique<Shader>("src/tests/06_PBR/03_IBL/01_Diffuse_irradiance/S01_Diffuse_irradiance_01_Background.Shader");
	...
	void T01_Diffuse_irradiance_01::OnUpdate(float deltaTime)
	{
	}

	void T01_Diffuse_irradiance_01::OnRender(GLFWwindow* window)
	{
	...
	void T01_Diffuse_irradiance_01::OnImGuiRender()
	{
	...
	void T01_Diffuse_irradiance_01::OnProcessInput(GLFWwindow * window, float deltaTime)
	{
	...
	void T01_Diffuse_irradiance_01::framebuffer_size_callback(GLFWwindow * window, int width, int height)
	{
		if (!window)
		{
			// 
	...
	void T01_Diffuse_irradiance_01::mouse_callback(GLFWwindow * window, double xpos, double ypos)
	{
	...
	void T01_Diffuse_irradiance_01::fill_sphere_mesh_vertices()
	{
	...
	void T01_Diffuse_irradiance_01::FramebufferSetup(int width, int height)
	{
