#include "T02_PBR_Lighting_01.h"
#include "GLFW/glfw3.h"

namespace test {

	T02_PBR_Lighting_01::T02_PBR_Lighting_01()
		: m_f_fov(45.0f),
		m_b_firstMouse(true),
		m_mouse_lock(false),
		...
		m_nrRows(7), m_nrColums(7), m_spacing(2.5)
	{
		...
		m_Shader = std::make_unique<Shader>("src/tests/06_PBR/02_PBR_Lighting/S02_PBR_Lighting_01.Shader");
	...
	void T02_PBR_Lighting_01::OnUpdate(float deltaTime)
	{
	}

	void T02_PBR_Lighting_01::OnRender(GLFWwindow* window)
	{
	...
	void T02_PBR_Lighting_01::OnImGuiRender()
	{
	...
	void T02_PBR_Lighting_01::OnProcessInput(GLFWwindow * window, float deltaTime)
	{
	...
	void T02_PBR_Lighting_01::framebuffer_size_callback(GLFWwindow * window, int width, int height)
	{
		if (!window)
		{
			// 
	...
	void T02_PBR_Lighting_01::mouse_callback(GLFWwindow * window, double xpos, double ypos)
	{
	...
	void T02_PBR_Lighting_01::fill_sphere_mesh_vertices()
	{
