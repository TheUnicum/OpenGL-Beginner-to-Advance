#include "T03_Materials_01.h"
#include "GLFW/glfw3.h"

namespace test {

	T03_Materials_01::T03_Materials_01()
		: m_f_fov(45.0f),
		...
		m_b_traspose_disable(false)
	{
		...
		m_Shader = std::make_shared<Shader>("src/tests/02_Lighting/03_Materials/S03_Materials_01.Shader");
	...
	void T03_Materials_01::OnUpdate(float deltaTime)
	{
	}

	void T03_Materials_01::OnRender(GLFWwindow* window)
	{
	...
	void T03_Materials_01::OnImGuiRender()
	{
		ImGui::Text("Color");
	...
	void T03_Materials_01::OnProcessInput(GLFWwindow * window, float deltaTime)
	{
	...
	void T03_Materials_01::framebuffer_size_callback(GLFWwindow * window, int width, int height)
	{
	}

	void T03_Materials_01::mouse_callback(GLFWwindow * window, double xpos, double ypos)
	{
