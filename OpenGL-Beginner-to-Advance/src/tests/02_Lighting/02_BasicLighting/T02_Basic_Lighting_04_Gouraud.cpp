#include "T02_Basic_Lighting_04_Gouraud.h"
#include "GLFW/glfw3.h"

namespace test {

	T02_Basic_Lighting_04_Gouraud::T02_Basic_Lighting_04_Gouraud()
		: m_f_fov(45.0f),
		...
		m_b_light_move_active(false), m_b_cube_rotating_active(false), m_b_cube_scale_active(false)
	{
		...
		m_Shader = std::make_unique<Shader>("src/tests/02_Lighting/02_BasicLighting/S02_Basic_Lighting_04_Gouraud.Shader");
	...
	void T02_Basic_Lighting_04_Gouraud::OnUpdate(float deltaTime)
	{
	}

	void T02_Basic_Lighting_04_Gouraud::OnRender(GLFWwindow* window)
	{
	...
	void T02_Basic_Lighting_04_Gouraud::OnImGuiRender()
	{
		ImGui::Text("Color");
	...
	void T02_Basic_Lighting_04_Gouraud::OnProcessInput(GLFWwindow * window, float deltaTime)
	{
	...
	void T02_Basic_Lighting_04_Gouraud::framebuffer_size_callback(GLFWwindow * window, int width, int height)
	{
	}

	void T02_Basic_Lighting_04_Gouraud::mouse_callback(GLFWwindow * window, double xpos, double ypos)
	{
