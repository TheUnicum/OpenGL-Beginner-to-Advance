#include "T02_Basic_Lighting_02.h"
#include "GLFW/glfw3.h"

namespace test {

	T02_Basic_Lighting_02::T02_Basic_Lighting_02()
		: m_f_fov(45.0f),
		...
		m_b_light_move_active(false), m_b_cube_rotating_active(false), m_b_cube_scale_active(false)
	{
		...
		m_Shader = std::make_unique<Shader>("src/tests/02_Lighting/02_BasicLighting/S02_Basic_Lighting_02.Shader");
	...
	void T02_Basic_Lighting_02::OnUpdate(float deltaTime)
	{
	}

	void T02_Basic_Lighting_02::OnRender(GLFWwindow* window)
	{
	...
	void T02_Basic_Lighting_02::OnImGuiRender()
	{
		ImGui::Text("Color");
	...
	void T02_Basic_Lighting_02::OnProcessInput(GLFWwindow * window, float deltaTime)
	{
	...
	void T02_Basic_Lighting_02::framebuffer_size_callback(GLFWwindow * window, int width, int height)
	{
	}

	void T02_Basic_Lighting_02::mouse_callback(GLFWwindow * window, double xpos, double ypos)
	{
