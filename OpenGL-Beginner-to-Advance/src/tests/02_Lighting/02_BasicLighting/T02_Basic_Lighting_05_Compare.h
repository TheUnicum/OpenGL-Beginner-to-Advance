...
namespace test {
	...
	class T02_Basic_Lighting_05_Compare : public Test
	{
	public:
		T02_Basic_Lighting_05_Compare();
		~T02_Basic_Lighting_05_Compare();
	...
	private:
		...
		std::shared_ptr<Shader> m_Shader, m_lightShader, m_Shader_Gouraud, m_currentShader;
