#include "T02_Basic_Lighting_03_ViewSpace.h"
#include "GLFW/glfw3.h"

namespace test {

	T02_Basic_Lighting_03_ViewSpace::T02_Basic_Lighting_03_ViewSpace()
		: m_f_fov(45.0f),
		...
		m_b_light_move_active(false), m_b_cube_rotating_active(false), m_b_cube_scale_active(false)
	{
		...
		m_Shader = std::make_unique<Shader>("src/tests/02_Lighting/02_BasicLighting/S02_Basic_Lighting_03_ViewSpace.Shader");
	...
	void T02_Basic_Lighting_03_ViewSpace::OnUpdate(float deltaTime)
	{
	}

	void T02_Basic_Lighting_03_ViewSpace::OnRender(GLFWwindow* window)
	{
		...
		float inv_ratio_aspect = 960.0f / 540.0f;
		{
			...
			m_Shader->SetUniformMat3f("u_transInvers_model", glm::mat3(glm::transpose(glm::inverse(view * model)))); // <-------
	...
	void T02_Basic_Lighting_03_ViewSpace::OnImGuiRender()
	{
		ImGui::Text("Color");
	...
	void T02_Basic_Lighting_03_ViewSpace::OnProcessInput(GLFWwindow * window, float deltaTime)
	{
	...
	void T02_Basic_Lighting_03_ViewSpace::framebuffer_size_callback(GLFWwindow * window, int width, int height)
	{
	}

	void T02_Basic_Lighting_03_ViewSpace::mouse_callback(GLFWwindow * window, double xpos, double ypos)
	{
