#include "T05_LightCaster_01_DirectL.h"
#include "GLFW/glfw3.h"

namespace test {

	T05_LightCaster_01_DirectL::T05_LightCaster_01_DirectL()
		: m_f_fov(45.0f),
		...
		m_b_light_move_active(false), m_b_cube_rotating_active(false)
	{
		...
		m_Shader = std::make_shared<Shader>("src/tests/02_Lighting/05_LightCasters/S05_LightCaster_01_DirectL.Shader");
	...
	void T05_LightCaster_01_DirectL::OnUpdate(float deltaTime)
	{
	}

	void T05_LightCaster_01_DirectL::OnRender(GLFWwindow* window)
	{
	...
	void T05_LightCaster_01_DirectL::OnImGuiRender()
	{
		ImGui::Text("Direction lights");
	...
	void T05_LightCaster_01_DirectL::OnProcessInput(GLFWwindow * window, float deltaTime)
	{
	...
	void T05_LightCaster_01_DirectL::framebuffer_size_callback(GLFWwindow * window, int width, int height)
	{
	}

	void T05_LightCaster_01_DirectL::mouse_callback(GLFWwindow * window, double xpos, double ypos)
	{
