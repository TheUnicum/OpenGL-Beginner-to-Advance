#include "T07_Transformations_03_First3D.h"
#include "GLFW/glfw3.h"

namespace test {

	T07_Transformations_03_First3D::T07_Transformations_03_First3D()
		...
		m_b_depth_test_active(false), m_b_depth_test_active_i_1(false)
	{
		...
		m_Shader = std::make_unique<Shader>("src/tests/01_Getting_started/07_Transformations/S07_Transformations_03_First3D.Shader");
		m_Shader->Bind();
	...
	void T07_Transformations_03_First3D::OnUpdate(float deltaTime)
	{
	}

	void T07_Transformations_03_First3D::OnRender()
	{
	...
	void T07_Transformations_03_First3D::OnImGuiRender()
	{
