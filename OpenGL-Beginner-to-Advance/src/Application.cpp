...
#include "tests/06_PBR/03_IBL/02_Specular_IBL_4_tests/T02_SpecIBL_04_Tests.h"
...
int main(void)
{
	...
	{	// make a scope to force delete a VertexBuffer before context windows get distroyed
		...
		// 09 SSAO Screen-space ambient occlusion
		test::TestMenu* TM_09_SSAO = new test::TestMenu(currentTest, "SSAO");
		TM_09_SSAO->RegisterTest<test::T09_SSAO_01>("SSAO 01 - Base");
		TM_05_Advanced_Lighting->RegisterMenu(*TM_09_SSAO);

		//-----------------------------
		// 06 PBR - Physically Based Rendering
		//-----------------------------
		test::TestMenu* TM_06_PBR = new test::TestMenu(currentTest, "Physically based rendering (PBR)");
		...
		test::TestMenu* TM_02_Specular_IBL_3 = new test::TestMenu(currentTest, "Specular IBL 3 : Model");
		...
		// 02 Specular IBL <C Tests>
		test::TestMenu* TM_02_Specular_IBL_4 = new test::TestMenu(currentTest, "Specular IBL 4 : Tests");
		TM_02_Specular_IBL_4->RegisterTest<test::T02_SpecIBL_04_Tests>("Spec.IBL 04 - Tests");
		TM_03_IBL->RegisterMenu(*TM_02_Specular_IBL_4);
		...
		testMenu->RegisterMenu(*TM_06_PBR);
